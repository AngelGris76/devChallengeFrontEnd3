const Golf = ({ ...props }) => {
  return (
    <svg
      ...
      // style='enable-background:new 0 0 501.921 501.921;'
      // xml:space='preserve'
      {...props}
      fill='currentColor'
    >
      <g>
        <g>
          <g>
            <path
              d='M390.376,139.417C390.376,62.542,327.834,0,250.96,0S111.544,62.542,111.544,139.417
            ...
            />
            <path
              d='M221.481,45.244c-16.418,5.134-31.295,14.563-43.022,27.266c-3.746,4.058-3.493,10.384,0.564,14.131
            ...
            />
            <path
              d='M330.057,80.445c-12.364-16.559-29.984-29.06-49.614-35.2c-5.272-1.649-10.881,1.287-12.529,6.559
